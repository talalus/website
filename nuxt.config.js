  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        ...
        name: 'keywords',
        content:
          'talal suhail, magento certified front end developer, magento frontend developer, magento pwa developer, vue storefront developer, magento pwa developer, magento theme developer'
      }
    ],
    htmlAttrs: {
